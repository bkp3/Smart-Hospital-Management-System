...
public class ViewAppointmentReceptionistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_appointment_receptionist);
            ...
            protected void onBindViewHolder(@NonNull AppointmentViewHolder holder, int position, @NonNull final Appointments model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(ViewAppointmentReceptionistActivity.this, ValidateAppointmentFromReceptionistToDoctorActivity.class);
