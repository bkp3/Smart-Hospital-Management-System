...
public class ViewPrescriptionDoctorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_prescription_doctor);

        Paper.init(this);

        PrescriptionsRef = FirebaseDatabase.getInstance().getReference().child("Prescription");

        recyclerView = findViewById(R.id.recycler_menu_doctor_prescription);
            ...
            protected void onBindViewHolder(@NonNull PrescriptionViewHolder holder, int position, @NonNull final Prescriptions model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(ViewPrescriptionDoctorActivity.this, EditPrescriptionDoctorActivity.class);
